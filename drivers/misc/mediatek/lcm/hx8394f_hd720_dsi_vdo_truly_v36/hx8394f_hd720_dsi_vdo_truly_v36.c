...
//#define GPIO_65132_ENP  (GPIO86 | 0x80000000)
//#define GPIO146         146
#define CUST_GPIO146         (GPIO146 | 0x80000000)
...
static int SET_RESET_PIN(int v){
 mt_set_gpio_mode(CUST_GPIO146, GPIO_MODE_00);
 mt_set_gpio_dir(CUST_GPIO146, GPIO_DIR_OUT);
 mt_set_gpio_out(CUST_GPIO146, v);
    return 0;
}
